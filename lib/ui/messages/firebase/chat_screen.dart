...
import 'package:gasht/ui/messages/firebase/chatUserDataModel.dart';
import 'package:gasht/ui/messages/firebase/newMessage.dart';
                ...
                children: [
                  ...
                  IconButton(
                      ...
                      icon: const Icon(Icons.emoji_emotions,
                          color: AppColors.appColor, size: 25)),
          ...
          MaterialButton(
            onPressed: () {
              if (_textController.text.isNotEmpty) {
                ...
                List<String> phoneNumbers = extractPhoneNumbers(_textController.text);
